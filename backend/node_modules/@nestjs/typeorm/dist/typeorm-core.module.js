...
let TypeOrmCoreModule = TypeOrmCoreModule_1 = class TypeOrmCoreModule {
    ...
    onApplicationShutdown() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                dataSource && (yield dataSource.destroy());
            }
            catch (e) {
    ...
    static createDataSourceFactory(options, dataSourceFactory) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createTypeormDataSource = dataSourceFactory !== null && dataSourceFactory !== void 0 ? dataSourceFactory : ((options) => new typeorm_1.DataSource(options));
